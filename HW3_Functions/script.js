...
const getRandomPassword = () => {
    const length = prompt(`Функція 9. Введіть кількість символів для генерації паролю`, '8');
    let password = '';
...
const deleteDuplicateLetter = () => {
    const str = prompt('Функція 12. Введіть речення для видалення букв які зустрічаються більше одного разу');
    let result = '';
